...
void RegisterDialog::slot_reg_mod_finish(ReqId id, QString res, ErrorCodes err)
{
    ...
    QJsonObject jsonObj1 = jsonDoc.object();
    qDebug()<< "email is " <<  jsonObj1["email"].toString();

    if(err != ErrorCodes::SUCCESS){
        qDebug()<< "ErrorCodes is " << err ;
...
void RegisterDialog::on_get_code_clicked()
{
    ...
    if(match){
        ...
        qDebug()<< "get_varifycode gate_url_prefix is " <<  QUrl(gate_url_prefix+"/get_varifycode").toString();
...
void RegisterDialog::on_sure_btn_clicked()
{
    ...
    qDebug()<< "user_register gate_url_prefix is " <<  QUrl(gate_url_prefix+"/user_register").toString();
